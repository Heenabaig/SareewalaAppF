...
public class ExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableAdapter(Context context, List<String> expandableListTitle, HashMap<String, List<String>> expandableListDetail){
    ...
    public View getChildView(int listPosition, final int expandedListPosition, boolean isLastChild, View convertView, ViewGroup parent){
        ...
        TextView expandedListTextView = convertView.findViewById(R.id.ListItem_text);
